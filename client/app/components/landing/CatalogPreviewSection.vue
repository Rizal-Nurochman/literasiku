...
const filteredBooks = BOOKS_PREVIEW
</script>
      ...
      <div class="space-y-8">
          ...
          <div class="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-start">
            <div class="space-y-3">
              ...
              <p class="text-sm text-muted">
                Menampilkan {{ filteredBooks?.length }} koleksi dari preview katalog Literasiku. Tekan Enter untuk melihat hasil penuh.
              </p>
            </div>
        ...
        <UPageGrid v-if="filteredBooks.length">
          <UCard
            ...
            class="group h-full cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/10"
            data-cursor="card"
